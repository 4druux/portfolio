    ...
    >
      ...
      <div className="xl:hidden">
        <div className="bg-[#F2EEE7] dark:bg-[#1a1a1a] flex justify-center pt-10 relative">
          <div className="absolute bottom-0 left-0 right-0 h-2/5 bg-gradient-to-t from-black/15 to-transparent"></div>
        ...
        <div className="bg-[#F2EEE7] dark:bg-[#1a1a1a] px-4 py-8">
          <div className="flex flex-col items-start gap-4 py-2 mb-4">
          ...
          <div className="mb-4">
            ...
            <p className="text-foreground/80 text-xs mb-4 line-clamp-4 min-h-[4rem]">
              {activeProject.description}
            </p>
            <div className="flex flex-wrap gap-2">
              {activeProject.tags.map((tag) => (
          ...
          <button className="flex items-start gap-1 w-full justify-center bg-gradient animate-gradientShift text-white font-bold py-3 px-8 rounded-full">
